...
function Dashboard() {
    ...
    return (<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
      ...
      {showClaim && (<div className="mb-8 rounded-2xl border border-primary/30 p-5 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4" style={{ background: "var(--gradient-primary)" }}>
          ...
          <Button onClick={handleClaim} disabled={claiming} className="bg-white text-primary hover:bg-white/90 shrink-0">
