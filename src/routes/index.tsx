  ...
  head: () => ({
    meta: [
      { title: "PlaceIQ — AI Placement Intelligence & Resume Analyzer" },
      {
        name: "description",
        content:
          "AI-powered resume analysis, ATS scoring, job matching, and mock interviews to land your dream placement.",
      },
      { property: "og:title", content: "PlaceIQ — AI Placement Intelligence" },
      {
        property: "og:description",
        content:
          "Upload your resume, get an ATS score, discover matched roles, and practice interviews — all powered by AI.",
      },
    ],
  }),
  component: Landing,
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6 text-sm text-white/80">
            {["No credit card", "ATS scoring", "Instant AI feedback"].map((t) => (
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f) => (
            ...
            >
              <div
                className="inline-flex h-11 w-11 items-center justify-center rounded-xl mb-4 group-hover:scale-110 transition-transform"
